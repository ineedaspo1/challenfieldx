...
class Init extends Modules {
	...
	public function get_conditions() {
		return array(
			array(
				'label'    => esc_html__( 'All course archives', 'thim-elementor-kit-pro' ),
				'value'    => 'all',
				'is_query' => false,
			),
			array(
				'label'    => esc_html__( 'Course page', 'thim-elementor-kit-pro' ),
				'value'    => 'course_page',
				'is_query' => false,
			),
			array(
				'label'    => esc_html__( 'All categories', 'thim-elementor-kit-pro' ),
				'value'    => 'course_categories',
				'is_query' => false,
			),
			array(
				'label'    => esc_html__( 'All tags', 'thim-elementor-kit-pro' ),
				'value'    => 'course_tags',
				'is_query' => false,
			),
			array(
				'label'    => esc_html__( 'Course search page', 'thim-elementor-kit-pro' ),
				'value'    => 'course_search',
				'is_query' => false,
			),
			array(
				'label'    => esc_html__( 'Select course term (category, tag)', 'thim-elementor-kit-pro' ),
				'value'    => 'course_term',
				'is_query' => true,
			),
		);
