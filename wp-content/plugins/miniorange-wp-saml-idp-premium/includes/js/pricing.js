...
jQuery(document).ready(function () {
    $idp = jQuery;
    document.getElementById("price-head").style.display = "block";
    document.getElementById("price-head1").style.display = "block";
    document.getElementById("idp-final-pricing").style.display = "none";
    let selection = document.getElementById("idp-pricing-users");
    let fullPrice = document.getElementById("full-price");
    let halfPrice = document.getElementById("half-price");
    ...
    selection.addEventListener("change", () => {
        ...
        if (selectedValue.value == 1) {
            ...
            document.getElementById("price-head").style.display = "none";
            document.getElementById("price-head1").style.display = "none";
            document.getElementById("idp-final-pricing").style.display = "block";
