...
?>
<h3 class="book-title"><?php esc_html_e( 'SPOTS OPEN', 'eduma' ); ?></h3>
...
<div class="event_register_area">
	...
	<form name="event_register" class="event_register" method="POST">
		...
		<ul class="info-event">
			<li>
				<div class="label"><?php esc_html_e( 'Total Spots', 'eduma' ); ?></div>
				<div class="value"><?php echo absint( $event->qty ); ?></div>
			</li>
			<li>
				<div class="label"><?php esc_html_e( 'Booked Spots', 'eduma' ); ?></div>
		...
		<div class="event_register_foot">
			...
			<?php else : ?>
				...
				<?php } else { ?>
					<button type="submit"
							class="event_register_submit event_auth_button" <?php echo $payments ? '' : 'disabled="disabled"' ?>><?php esc_html_e( 'SIGN ME UP', 'eduma' ); ?></button>
				<?php } ?>
			<?php endif ?>
